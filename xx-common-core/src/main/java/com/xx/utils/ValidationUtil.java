...
import com.xx.exception.DataEmptyException;
...
public class ValidationUtil {
    ...
    public static void notEmpty(Object aObj) {
        notEmpty(aObj, ResultCodeEnum.DATA_EMPTY_FAIL.getMsg());
    }

    public static void notEmpty(Object aObj, String message) {
        if (ValidationUtil.isEmpty(aObj)) {
            throw new DataEmptyException(message);
        }
    }

    public static void notAllEmpty(Object... values) {
        if (!ValidationUtil.allEmpty(values)) {
            throw new DataEmptyException(ResultCodeEnum.DATA_EMPTY_FAIL.getMsg());
        }
    }
     ...
     * @param values
     */
    public static void notEveryEmpty(Object... values) {
        if (ValidationUtil.everyEmpty(values)) {
            throw new DataEmptyException(ResultCodeEnum.DATA_EMPTY_FAIL.getMsg());
        }
    }
}
